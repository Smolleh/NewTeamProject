...
## Backend (Django)
The backend of the system utilizes the Django framework to process requests from the users and handle any communication between the frontend actions and the database. 
### Database (SQLite)
...
### API
API endpoints are used to retrieve and manipulate the data in the sytem through the use of Django views. 
### Authentication
